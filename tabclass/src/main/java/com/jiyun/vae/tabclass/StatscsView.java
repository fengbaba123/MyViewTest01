...
//      this.invalidate(); //失效的意思。
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 1 绘制坐标线：
        canvas.drawLine(100, 10, 100, 820, axisLinePaint);

        canvas.drawLine(100, 820, width-10 , 820, axisLinePaint);

        // 2 绘制坐标内部的水平线

        int leftHeight = 800;// 左侧外周的 需要划分的高度：
        ...
        {
            canvas.drawText(xTitles[i], 100+step*(i+1), 860 , titlePaint);
        }
